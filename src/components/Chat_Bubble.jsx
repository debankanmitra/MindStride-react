			...
			<li className="max-w-4xl py-2 px-4 sm:px-6 lg:px-8 mx-auto flex gap-x-2 sm:gap-x-4">
				...
				<div className="grow max-w-[90%] md:max-w-2xl w-full space-y-3">
					...
					<div className="space-y-3">
						...
						Hi {localStorage.getItem("name")}, Mindstride is a RAG-based chat assistant designed to support mental health, personal growth, and self-improvement. Ask me anything you want to know about mental health or personal growth or self-improvement. 
						</p>
					</div>
					{/* <!-- End Card --> */}
					...
					<div>
						<div className="sm:flex sm:justify-between">
							<div className="space-y-2 sm:space-y-0 sm:space-x-2">
								...
								<button
									type="button"
									className="py-2 px-3 inline-flex items-center gap-x-2 text-sm rounded-full border border-transparent text-gray-500 hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none"
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
										width="16"
