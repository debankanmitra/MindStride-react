			...
			>
				...
				<div className="mt-auto">
					<div className="py-2.5 px-7">
						<a
							href="https://twitter.com/mitra_debankan"
							target="_blank"
							className="inline-flex items-center gap-x-2 text-sm cursor-pointer hover:text-violet-600"
						>
							<svg
								className="flex-shrink-0 size-4"
								xmlns="http://www.w3.org/2000/svg"
					...
					<div className="py-2.5 px-7">
						<p className="inline-flex items-center gap-x-2 text-sm cursor-pointer hover:text-violet-600">
							<svg
								className="flex-shrink-0 size-4"
								xmlns="http://www.w3.org/2000/svg"
								width="24"
					...
					<div className="py-2.5 px-7">
						<a
							...
							target="_blank"
							className="inline-flex items-center gap-x-2 text-md cursor-pointer"
						>
							<svg
								className="flex-shrink-0 size-4"
								fill="violet"
